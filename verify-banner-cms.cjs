...
(async()=>{
 ...
 pointer('pointerdown',250);pointer('pointermove',180);assert.equal(rail.style.transform,'translateX(-70px)','message follows left drag');pointer('pointerup',180);control.click();assert.equal(swipeOpens,0,'swipe synthetic click does not open VIP');a.tick(450);
