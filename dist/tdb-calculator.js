/* TDB Treatment Calculator v1.4.4 — deterministic pricing and planning rules. */
...
(function () {
  ...
  class View {
    ...
    timelineControls(e){
      ...
      const warning='<div id="'+id+'-deadline" class="tdbc-timing-warning text-size-small"><p>Your selected plan needs a little more time. We’re no strangers to deadlines: being based at a wedding venue, we see plenty of brides and have become experienced at exploring what may be possible for the day that matters. Let’s talk about the date, your priorities and the options for getting you closer to your smile in time.</p>'+wedding+'</div>';
