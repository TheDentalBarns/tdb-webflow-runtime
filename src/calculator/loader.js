...
(function(){
 ...
 function start(){
   ...
   document.addEventListener('click',e=>{const link=e.target.closest(selector);if(!link||window.TDBCalculator||e.defaultPrevented||e.…1399 tokens truncated…=0&&v.tier<=2?v.tier:null};
