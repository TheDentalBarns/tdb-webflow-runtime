(() => {
  ...
  const VERSION = '0.8.23-parallax-touch-hold-staging';
  ...
  const footerRuntimePromise = loadScript(
    'https://cdn.jsdelivr.net/gh/TheDentalBarns/tdb-webflow-runtime@73ccf1769e2828620765c14b448be24f1213a116/dist/tdb-footer-runtime.min.js',
